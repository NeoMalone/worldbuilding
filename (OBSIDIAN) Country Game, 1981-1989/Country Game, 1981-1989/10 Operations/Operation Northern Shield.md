...
Operation Northern Shield is a named operation extracted directly from the PDF transcript and added
to complete the operation registry.

## Canon Role

The PDF names Operation Northern Shield as part of the Country Game's sequence of invasions,
...
Search the extracted transcript for `Operation Northern Shield` to find the exact surrounding event
context.
