...
Operation Iron Resolve is a named operation extracted directly from the PDF transcript and added to
complete the operation registry.

## Canon Role

The PDF names Operation Iron Resolve as part of the Country Game's sequence of invasions, campaigns,
...
Search the extracted transcript for `Operation Iron Resolve` to find the exact surrounding event
context.
